      ...
      <div className="p-6 sm:p-12">
        ...
        <div className="flex flex-col items-center">
          <Draggable 
            ...
            <div className="border-solid border-black border-2 z-10
                w-full md:w-2/3 lg:w-1/2 rounded-xl bg-white relative top-0 right-0">
              <div className="handle w-full bg-gray-300 rounded-t-lg px-2 text-black font-mono font-bold
              ...
              <div className="p-6 m-0">
                <div className="border-solid border-black border-2 p-8 rounded-xl">
                  ...
                  <p className="text-mxs">
                    Have you ever felt burdened by the weight of your ever-increasing responsibilities? 
          ...
          <Draggable 
            ...
            <div className="w-fit h-fit border-solid border-white border-4
              ...
              <div className="handle w-full bg-gray-300 rounded-t-lg px-2 text-xs cursor-pointer
                  border-black border-solid border-b-4 flex justify-between items-center">
