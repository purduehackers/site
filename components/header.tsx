const Header = () => (
  <div className="h-screen bg-amber-100 flex flex-col justify-center items-center gap-y-4">
    <div className="shadow-blocks shadow-gray-600 border-4 bg-amber-400 border-black p-6 rounded-md w-10/12 lg:w-auto">
      <h1 className="text-center font-bold text-4xl sm:text-8xl lg:text-9xl">
        Purdue Hackers
      </h1>
    </div>
