...
const Community = () => {
  ...
  useEffect(() => {
    const height = document.getElementById('messages')?.offsetHeight
  ...
  return (
    <div className="bg-yellow-discord-role">
      <div className="flex flex-col p-6 sm:p-12">
        ...
        <div id="messages" className="flex flex-col items-center mt-8">
          ...
          <div className="flex flex-col gap-2 absolute translate-y-40 w-11/12 p-4 border-4 border-black shadow-email shadow-gray-900/70 bg-white max-w-xl">
            ...
            <p>
              The heart & soul of Purdue Hackers is our community on Discord
              with 1000+ people. Share what you've made in{' '}
              <span className="channel-name">#ship</span>, chat about rainbows
              in <span className="channel-name">#lounge</span>, share your music
              musings in <span className="channel-name">#music</span>, ask for
              technical help in <span className="channel-name">#code</span>
              —wherever you look, you'll find friendly, kind, radically
              inclusive, and <span className="italic">really cool</span> people.
              It's also where we announce upcoming events—in particular,{' '}
              <span className="channel-name">#announcements</span>.
            </p>
            <p>
              If you go to Purdue, or are planning to go to Purdue, we would
