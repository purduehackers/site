...
We’ve partnered with companies like Facebook, Bloomberg, Cloudflare, and Vercel, as well as run [an AMA with Steve Wozniak](https://events.purduehackers.com/ama-with-steve-wozniak).
