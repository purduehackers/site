  ...
  return (
    <div className="bg-teal-500 min-h-screen p-24">
      <div className="border-2 border-black flex justify-between items-center bg-white
            w-11/12 sm:w-5/6 md:w-4/5 mx-auto h-12 px-8 mb-8 shadow-email">
      ...
      <div className="flex w-full">
        <Draggable
            disabled={!draggable}
            handle=".handle">
          <div className="border-2 border-black w-11/12 sm:w-[36rem] mx-auto mb-8 shadow-email">
        ...
        <div className="border-2 border-black flex flex-col bg-white
              w-11/12 sm:w-1/6 md:w-64 h-96 mb-8 shadow-email">
          <div className="inbox-email">
                <h4>an invitation</h4>
          </div>
          <div className="border-2 border-black flex flex-col bg-white
              w-11/12 sm:w-1/6 md:w-64 h-12 p-8">
                <h4>***IMPORTANT!***</h4>
          </div>
          <div className="border-2 border-black flex flex-col bg-white
              w-11/12 sm:w-1/6 md:w-64 h-12 p-8">
